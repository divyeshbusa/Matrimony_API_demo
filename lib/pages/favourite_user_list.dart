...
class _FavouriteUserState extends State<FavouriteUser> {
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: FutureBuilder<List<User>?>(
              ...
              future: isGetData ? RemoteService().FavData('/userlist?IsFavorite=true') : null),
        ),
      ),
    );
  }
  ...
  //   var uri = Uri.parse(
  //       'https://62da4f4b9eedb699636ae83c.mockapi.io/userlist/userlist?IsFavorite=true');
  //   var response = await client.get(uri);
  //   var data = jsonDecode(response.body.toString());
  //   if (response.statusCode == 200) {
  //     for (Map<String, dynamic> index in data) {
  //       searchList.add(User.fromJson(index));
  //     }
  //     return searchList;
  //   } else {
  //     return searchList;
