      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: FutureBuilder<List<User>?>(
                      ...
                      Expanded(
                        child: ListView.builder(
                          itemBuilder: (context, index) {
                            print("::::::::searchList[index].toString():::::${searchList[index].id}");
                            return InkWell(
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => ProfileDetail(searchList[index].id.toString()),
                                  ),
                                );
                              },
                              child: Card(
              ...
              future: isGetData ? RemoteService().getData('/userlist') : null),
        ),
      ),
    );
  }
  ...
  showAlertDialog(BuildContext context, index) {
    Widget yesButton = TextButton(
      ...
      onPressed: () async {
        var id = searchList[index].id;
        int deletedUserID =
            await RemoteService().deleteData('/userlist/$id');
